# CHANGELOG — Architecture Review & Findings

> Архив фазовых логов и вех проекта (History). Текущие открытые находки и план волн — в [`TODO.md`](./TODO.md). Автоматически сформирован из исторических section TODO.md; пополняйте синхронно с выпусками.
