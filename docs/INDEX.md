...
|---|---|---|
| `AGENTS.md` | 201 | ВСЕГДА первым: карта репо, команды, факты, протоколы |
| `README.md` | 468 | Только нужная секция: Installation / Running / Docker / Configuration / Security |
| `README.ru.md` | 466 | Русская версия; EN — канон при расхождениях |
| `TODO.md` | 211 | Живой бэклог: пункты A–G + волны §G. Читать целиком можно (короткий) |
...
| `REMOTE_TROUBLESHOOTING.md` | 195 | Роадмап remote/SSH: статусы #1–#8 (что FIXED, что TODO) |
...
| Файл | Строк | Когда читать |
|---|---|---|
| `docs/ARCHITECTURE.md` | 178 | Устройство плагинов/адаптеров/harness; для новых фич |
| `docs/DEVELOPMENT.md` | 279 | Setup, env/секреты, аудит, shutdown, тесты — для onboard-задач |
...
| `docs/HARNESS_ANALYSIS.md` | 194 | Идеология Harness vs текущее состояние (перенесён из корня, C6) |
